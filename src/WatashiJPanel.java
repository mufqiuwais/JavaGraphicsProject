...
public class WatashiJPanel extends JPanel{
    public void paintComponent(Graphics g){
        ...
        Shape drawQuadCurve5 = new QuadCurve2D.Float(300,150,300,150,300,45);
        ...
        polygon10.addPoint(230,178);
        polygon10.addPoint(280,150);
        polygon10.addPoint(300,169);
        ...
        polygon11.addPoint(298,342);
        polygon11.addPoint(298,305);
        polygon11.addPoint(325,190);
        polygon11.addPoint(351,172);
        polygon11.addPoint(390,178);
        polygon11.addPoint(508,280);
        polygon11.addPoint(520,307);
        polygon11.addPoint(512,365);
        polygon11.addPoint(428,470);
        polygon11.addPoint(388,470);
        Polygon polygon12 = new Polygon();
        polygon12.addPoint(520,305);
        polygon12.addPoint(512,365);
        polygon12.addPoint(565,325);
        polygon12.addPoint(578,303);
        Polygon polygon13 = new Polygon();
        polygon13.addPoint(260,308);
        polygon13.addPoint(298,300);
        polygon13.addPoint(298,342);
        Polygon polygon14 = new Polygon();
        polygon14.addPoint(260,310);
        polygon14.addPoint(285,315);
        polygon14.addPoint(318,400);
        polygon14.addPoint(260,380);
        Polygon polygon15 = new Polygon();
        polygon15.addPoint(565,325);
        polygon15.addPoint(555,380);
        polygon15.addPoint(500,400);
        polygon15.addPoint(525,325);
        polygon15.addPoint(545,305);
        Polygon polygon16 = new Polygon();
        polygon16.addPoint(318,250);
        polygon16.addPoint(340,240);
        polygon16.addPoint(372,241);
        polygon16.addPoint(383,244);
        polygon16.addPoint(389,252);
        polygon16.addPoint(340,248);
        Polygon polygon17 = new Polygon();
        polygon17.addPoint(422,249);
        polygon17.addPoint(440,242);
        polygon17.addPoint(450,252);
        polygon17.addPoint(422,249);
        Polygon polygon18 = new Polygon();
        polygon18.addPoint(348,438);
        polygon18.addPoint(465,440);
        polygon18.addPoint(465,600);
        polygon18.addPoint(348,600);
        polygon18.addPoint(352,508);
        Polygon polygon19 = new Polygon();
        polygon19.addPoint(334,421);
        polygon19.addPoint(348,438);
        polygon19.addPoint(349,458);
        Polygon polygon20 = new Polygon();
        polygon20.addPoint(484,421);
        polygon20.addPoint(465,440);
        polygon20.addPoint(464,458);
        Polygon polygon21 = new Polygon();
        polygon21.addPoint(352,508);
        polygon21.addPoint(348,600);
        polygon21.addPoint(289,600);
        Polygon polygon22 = new Polygon();
        polygon22.addPoint(464,508);
        polygon22.addPoint(540,600);
        polygon22.addPoint(465,600);
        //=================First Layer=================
        ...
        graph.fillPolygon(polygon12);
        graph.fillPolygon(polygon13);
        graph.fillPolygon(polygon19);
        graph.fillPolygon(polygon20);
        graph.fillPolygon(polygon21);
        graph.fillPolygon(polygon22);
        graph.fillPolygon(polygon10);
        graph.fill(leftShirt1);
        graph.fill(rightShirt1);
        graph.setStroke(new BasicStroke(4.0f));
        graph.drawPolygon(polygon1);
        graph.setPaint(new Color(200, 255, 255));
        graph.fillPolygon(polygon11);
        graph.fillPolygon(polygon14);
        graph.fillPolygon(polygon15);
        graph.fillPolygon(polygon18);
        graph.fill(faceCurve1);
        graph.fill(faceCurve2);
        graph.fill(faceCurve3);
        graph.fill(leftEarCurve1);
        graph.fill(leftEarCurve2);
        graph.fill(rightEarCurve1);
        graph.fill(rightEarCurve2);
        graph.fill(drawQuadCurve20);
        graph.fill(drawQuadCurve21);
        graph.fill(drawQuadCurve11);
        ...
        graph.setColor(Color.WHITE);
        graph.fillPolygon(polygon16);
        graph.fillPolygon(polygon17);
